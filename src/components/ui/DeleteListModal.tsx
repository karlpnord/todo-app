...
const DeleteListModal = ({ toggleModal, listName, listId }: Props) => {
  ...
  return (
    ...
    >
      <motion.div
        ...
        transition={{ duration: 0.3 }}
      >
        <h2 className='text-xl text-gray-100 font-bold'>Delete List</h2>
        <p className='text-gray-200'>"{listName}" will be deleted permanently.</p>
        <div className='flex gap-2 mt-8'>
          <Button title='Delete' className='bg-red-600 hover:bg-red-500 flex-1' clickHandler={deleteListHandler} />
